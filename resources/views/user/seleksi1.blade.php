                     ...
                     <div class="card card-primary">
                        ...
                        <form action="{{ route('pendaftar.upload.seleksi1') }}" method="POST" enctype="multipart/form-data" class="was-validated">
                           ...
                           <label for="exampleInputEmail1">Silahkan input ulang jika ingin mengubah data Challenge</label>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input id="url_video" type="text" class="form-control" name="url_video" value="{{ $data->url_video }}" required autofocus>
                                    @else
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-6">
                                 @if(!empty ($data->url_writing))
                                    <input id="url_writing" type="text" class="form-control" name="url_writing" value="{{ $data->url_writing }}" required autofocus>
                                    @else
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="custom-control custom-radio custom-control-inline mt-2">
                                       <input type="radio" id="customRadioInline1" name="mentoring" class="custom-control-input" value="Pernah" {{ ($data->mentoring=="Pernah")? "checked" : "" }} required>
                                       <label class="custom-control-label" for="customRadioInline1">ya</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                       <input type="radio" id="customRadioInline2" name="mentoring" class="custom-control-input" value="Belum Pernah" {{ ($data->mentoring=="Belum Pernah")? "checked" : "" }} required>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 @if(!empty($data->mentoring_rutin))
                                 <textarea id="mentoring_rutin" type="text" class="form-control{{ $errors->has('mentoring_rutin') ? ' is-invalid' : '' }}" name="mentoring_rutin" value="{{ $data->mentoring_rutin }}" rows="3"> {{ $data->mentoring_rutin }}</textarea>
                                 @else
                                 <textarea id="mentoring_rutin" type="text" class="form-control{{ $errors->has('mentoring_rutin') ? ' is-invalid' : '' }}" name="mentoring_rutin" value="{{ $data->mentoring_rutin }}" rows="3"> Abaikan Bila Menjawab "Tidak"</textarea>
                                 @endif
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="futur" type="text" class="form-control{{ $errors->has('futur') ? ' is-invalid' : '' }}" name="futur" value="{{ $data->futur }}" rows="3" required autofocus>{{ $data->futur }}</textarea>
                                 @if ($errors->has('futur'))
                                 <span class="invalid-feedback" role="alert">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="faith" type="text" class="form-control{{ $errors->has('faith') ? ' is-invalid' : '' }}" name="faith" value="{{$data->faith }}" rows="3" required autofocus>{{$data->faith }}</textarea>
                                 @if ($errors->has('faith'))
                                 <span class="invalid-feedback" role="alert">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="ethic" type="text" class="form-control{{ $errors->has('ethic') ? ' is-invalid' : '' }}" name="ethic" value="{{ $data->ethic }}" rows="3"required autofocus>{{ $data->ethic }}</textarea>
                                 @if ($errors->has('ethic'))
                                 <span class="invalid-feedback" role="alert">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="question1" type="text" class="form-control{{ $errors->has('question1') ? ' is-invalid' : '' }}" name="question1" value="{{ $data->quetion1 }}" rows="3"required autofocus>{{ $data->question1 }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="question2" type="text" class="form-control{{ $errors->has('question2') ? ' is-invalid' : '' }}" name="question2" value="{{ $data->question2 }}" rows="3"required autofocus>{{ $data->question2 }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="question3" type="text" class="form-control{{ $errors->has('question3') ? ' is-invalid' : '' }}" name="question3" value="{{ $data->question3 }}" rows="3"required autofocus>{{ $data->question3 }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="question4" type="text" class="form-control{{ $errors->has('question4') ? ' is-invalid' : '' }}" name="question4" value="{{ $data->question4}}" rows="3"required autofocus>{{ $data->question4}}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6 was-validated">
                                 <div class="custom-control custom-radio custom-control-inline mt-2">
                                    <input type="radio" id="customRadioInline3" name="organisasi" class="custom-control-input" value="Pernah" {{ ($data->organisasi=="Pernah")? "checked" : "" }} required>
                                    <label class="custom-control-label" for="customRadioInline3">Pernah</label>
                                 </div>
                                 <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadioInline4" name="organisasi" class="custom-control-input" value="Belum Pernah" {{ ($data->organisasi=="Belum Pernah")? "checked" : "" }} required>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 @if(!empty ($data->aktif_organiasi))
                                 <textarea id="aktif_organisasi" type="text" class="form-control{{ $errors->has('aktif_organisasi') ? ' is-invalid' : '' }}" name="aktif_organisasi" value="{{ $data->aktif_organiasi }}" rows="3">{{ $data->aktif_organiasi }}</textarea>
                                 @else
                                 <textarea id="aktif_organisasi" type="text" class="form-control{{ $errors->has('aktif_organisasi') ? ' is-invalid' : '' }}" name="aktif_organisasi" value="{{ $data->aktif_organiasi }}" rows="3">Abaikan Bila Menjawab "Belum Pernah"</textarea>
                                 @endif
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="question5" type="text" class="form-control{{ $errors->has('question5') ? ' is-invalid' : '' }}" name="question5" value="{{ $data->question5 }}" rows="3"required autofocus>{{ $data->question5 }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="question6" type="text" class="form-control{{ $errors->has('question6') ? ' is-invalid' : '' }}" name="question6" value="{{ $data->question6 }}" rows="3"required autofocus>{{ $data->question6 }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="entrepreneurship" type="text" class="form-control{{ $errors->has('entrepreneurship') ? ' is-invalid' : '' }}" name="entrepreneurship" value="{{ $data->entrepreneurship }}" rows="3"required autofocus>{{ $data->entrepreneurship }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="alasan_wirausaha" type="text" class="form-control{{ $errors->has('alasan_wirausaha') ? ' is-invalid' : '' }}" name="alasan_wirausaha" value="{{  $data->alasan_wirausaha }}" rows="3"required autofocus>{{ $data->alasan_wirausaha }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <div class="custom-control custom-radio custom-control-inline mt-2">
                                    <input type="radio" id="customRadioInline5" name="pernah_wirausaha" class="custom-control-input" value="Pernah"  {{ ($data->pernah_wirausaha=="Pernah")? "checked" : "" }}  required>
                                    <label class="custom-control-label" for="customRadioInline5">Pernah</label>
                                 </div>
                                 <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" id="customRadioInline6" name="pernah_wirausaha" class="custom-control-input" value="Belum Pernah" {{ ($data->pernah_wirausaha=="Belum Pernah")? "checked" : "" }} required>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="exp_wirausaha" type="text" class="form-control{{ $errors->has('alamat') ? ' is-invalid' : '' }}" name="exp_wirausaha" value="{{ $data->exp_wirausaha }}" rows="3">{{ $data->exp_wirausaha }}</textarea>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea id="omset" type="text" class="form-control{{ $errors->has('omset') ? ' is-invalid' : '' }}" name="omset" value="{{ $data->omset }}" rows="3"required autofocus>{{ $data->omset }}</textarea>
                                 @if ($errors->has('omset'))
                                 <span class="invalid-feedback" role="alert">
