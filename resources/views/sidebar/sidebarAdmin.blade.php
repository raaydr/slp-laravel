         ...
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
               ...
               <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                     @if ( Route::currentRouteName() == "admin.PembuatanAlurPendaftaran" )
                        <a href="{{ route('admin.PembuatanAlurPendaftaran') }}" class="nav-link active">
                     @else
                        <a href="{{ route('admin.PembuatanAlurPendaftaran') }}" class="nav-link ">
                     @endif
                           <i class="far fa-circle nav-icon"></i>
                  ...
                  <li class="nav-item">
                     @if ( Route::currentRouteName() == "admin.ListSemuaPendaftar" )
                        <a href="{{ route('admin.ListSemuaPendaftar') }}" class="nav-link active">
                     @else
                        <a href="{{ route('admin.ListSemuaPendaftar') }}" class="nav-link ">
                     @endif
                           <i class="far fa-circle nav-icon"></i>
                           <p>Data Pendaftar</p>
                        </a>
