         ...
         <div class="col-md-4">
            ...
            <div class="card card-primary">
               ...
               <form id="formPersyaratan" enctype="multipart/form-data" >
                  ...
                  <div class="card-body">
                     <div class="form-group row">
                        <label for="persyaratan" class="col-md-12 col-form-label text-md-center">{{ __('Persyaratan') }}</label>
                        <div class="col-md-12">
                           <textarea id="persyaratan" type="text" class="form-control" name="persyaratan" value="{{ old('persyaratan') }}"></textarea>
     ...
     $("#example1")
          .DataTable({
              ...
              columns:[
                 ...
                 {data:'manfaat',name:'manfaat',orderable: true,searchable: true},
