               ...
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1>TARGET TUGAS SPEAKING</h1>
                     </div>
                     <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                           <li class="breadcrumb-item"><a href="#">Tugas</a></li>
                           <li class="breadcrumb-item active">Target Speaking</li>
                        </ol>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="col-12" id="accordion">
                        ...
                        <div class="card card-success card-outline">
                           ...
                           <div class="card-footer">
                                <a class="btn btn-primary" href="{{ route('target.InputTugasSpeaking',$target_tugas->id) }}">Kerjakan</a>
                              </div>
                        </div>
                        @endforeach
                     </div>
