    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="https://slpindonesia.com/">Masuk</a></li>
        </ul>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
            ...
            <p class="description"> Pendaftaran dan seleksi pemberkasan dimulai dari tanggal 15-25 April 2021. Akses Link pendaftaran <a href="#" ><b>disini</b></a>.</p>
          </div>
          <div class="col-lg-4 col-md-6 box wow bounceInUp" data-wow-duration="1.4s">
