            ...
            <section class="content">
               <div class="container-fluid">
                  ...
                  <div class="alert alert-danger alert-dismissable md-5">
                     <button type="button" class ="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                     <h5><i class="icon fa fa-info"></i>Batal Periksa</h5>
                     {{session('batal')}}.
                  </div>
                  @endif
                  <div class="col-md-12">
                     ...
                     <div class="card card-primary">
                        <div class="card-header">
                           <h3 class="card-title">Quest Peserta hari ke - {{$hari}}</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <div class="card-body">
                           <div class="row">
                              <div class="form-group col-md-6">
                                 ...
                                 <input type="text" class="form-control" name="id" value="{{$peserta->user_id}}" readonly>
                              </div>
                              <div class="form-group col-md-6">
                                 <label for="exampleInputPassword1">Nama</label>
                                 <input type="text" class="form-control" name="nama" value="{{ $peserta->nama}}"readonly>
                              </div>
                           </div>
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-6 col-form-label ">
                              <button class="btn btn-primary btn-sm" data-toggle="modal" data-myid="{{$data->id}}" data-myname="{{$peserta->nama}}" data-target="#modal-note"target="_blank">
                                 <i class="fas fa-info"> </i>
                                 edit
                                 </button>
                              </div>
                        ...
                        <div class="modal fade" id="modal-note">
                           <div class="modal-dialog">
                              <div class="modal-content bg-primary">
                                 ...
                                 <form method="POST" action="{{route('fasil.note.quest')}}" enctype="multipart/form-data" class="was-validated">
                                    {{csrf_field()}}
                                    <div class="modal-body">
                                       <div class="form-group row">
                                          <label for="id" class="col-md-5 col-form-label text-md-right">{{ __('id') }}</label>
